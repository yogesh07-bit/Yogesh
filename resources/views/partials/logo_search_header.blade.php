                    ...
                    <div class="container my-0dot5 my-xl-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <!-- ========== HEADER SIDEBAR ========== -->
                                <aside id="sidebarHeader1" class="d-none u-sidebar u-sidebar--left" aria-labelledby="sidebarHeaderInvoker">
                            ...
                            <!-- End Search Bar -->
                            <!-- Header Icons -->
                            <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static d-flex">
                                <div class="d-none mr-2 border rounded-pill py-1d border-color-6 max-width-174 text-lh-sm px-4 d-xl-inline-flex align-items-center">
                                    <div class="font-size-12 text-gray-5">Remaining to  Free Delivery:</div>
                                    <div class="font-size-15 font-weight-bold text-violet1 ml-2">₹120</div>
                                </div>
                                    ...
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3 d-xl-none">
                                            <a href="../shop/cart.html" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                                ...
                                                <span class="bg-lg-down-black width-22 height-22 bg-primary position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12 text-white">2</span>
                                                ...
                                                <ul class="list-unstyled px-3 pt-3">
                                                        ...
                                                        <div class="">
                                                            <ul class="list-unstyled row mx-n2">
                                                                <li class="px-2 col-auto">
                                                                    <img class="img-fluid" src="public/assets/stationery-set-on.png" alt="Image Description">
                                                                </li>
                                                                <li class="px-2 col">
                                                                    <h5 class="text-violet1 font-size-14 font-weight-bold">Ultra Wireless S50 Headphones S50 with Bluetooth</h5>
                                                    ...
                                                    <li class="border-bottom pb-3 mb-3">
                                                        <div class="">
                                                            <ul class="list-unstyled row mx-n2">
                                                                <li class="px-2 col-auto">
                                                                    <img class="img-fluid" src="public/assets/img/75X75/img2.jpg" alt="Image Description">
                                                                </li>
                                                                <li class="px-2 col">
                                                                    <h5 class="text-violet1 font-size-14 font-weight-bold">Widescreen NX Mini F1 SMART NX</h5>
