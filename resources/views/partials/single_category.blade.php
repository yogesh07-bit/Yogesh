...
<pre>
<!-- {{ json_encode($data['category_items'] , JSON_PRETTY_PRINT ) }} -->
<!-- {{ json_encode($data['all_category'] , JSON_PRETTY_PRINT ) }} -->
</pre>
 ...
 <div class="row mb-8">
                                    ...
                                    <div id="sidebarNav1Collapse" class="collapse show" data-parent="#sidebarNav">
                                        <ul id="sidebarNav1" class="list-unstyled dropdown-list">
                                            ...
                                            @foreach ($data['all_category'] as $category)
                                                ...
                                                <li><a class="dropdown-item" href="{{url('category/' . $category->category_slug . '/' . $category->id) }}">{{$category->category_name}}</a></li>
                    ...
                    <div class="col-xl-9 col-wd-9gdot5">
                        ...
                        <div class="d-block d-md-flex flex-center-between mb-3">
                            <h3 class="font-size-25 mb-2 mb-md-0"> {{$data['category_details']['category_name']}}</h3>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade pt-2" id="pills-one-example1" role="tabpanel" aria-labelledby="pills-one-example1-tab" data-target-group="groups">
                                <ul class="row list-unstyled products-group no-gutters">
                                    ...
                                    @foreach ($data['category_items'] as $item)
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2"><a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="font-size-12 text-gray-5">{{$item->category->category_name}}</a></div>
                                                    <h5 class="mb-1 product-item__title"><a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="text-blue font-weight-bold">{{$item->product_title}}</a></h5>
                                                    <div class="mb-2">
                                                        <a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="d-block text-center"><img class="img-fluid" src="{{ asset($item->images?->highlighted ?? 'default/image.jpg') }}" alt="Product Image" ></a>
                                                    </div>
                                                    <div class="flex-center-between mb-1">
                                                        <div class="prodcut-price">
                                                            <div class="text-gray-100">₹{{$item->mrp}}</div>
                                                        </div>
                                                        <div class="d-none d-xl-block prodcut-add-cart">
                                                            <a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <ul class="row list-unstyled products-group no-gutters">
                                    ...
                                    <li class="col-6 col-md-3 col-wd-2gdot4 product-item">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2"><a href="{{url('category/' . $item->category->category_name . '/' . $item->category->id) }}" class="font-size-12 text-gray-5">{{$item->category->category_name}}</a></div>
                                                    <h5 class="mb-1 product-item__title"><a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="text-blue font-weight-bold">{{$item->product_title}}</a></h5>
                                                    <div class="mb-2">
                                                        <a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="d-block text-center"><img class="img-fluid" src="{{ asset($item->images?->highlighted ?? 'default/image.jpg') }}" alt="Product Image"></a>
                                                    </div>
                                                    ...
                                                    @foreach ($item->description as $des)
                                                        @if ($des->display_title == 0)
                                                            {{
                                                              Str::limit(  strip_tags($des->description), 250,'...')
                                                            }}
                                                        @endif
                                        ...
                                        <div class="product-item__outer w-100">
                                            <div class="product-item__inner remove-prodcut-hover py-4 row">
                                                ...
                                                <div class="product-item__body col-6 col-md-5">
                                                    <div class="pr-lg-10">
                                                        <div class="mb-2"><a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="font-size-12 text-gray-5">{{$item->category->category_name}}</a></div>
                                                        <h5 class="mb-2 product-item__title"><a href="{{url('product/' . $item->slug . '/' . $item->id) }}" class="text-blue font-weight-bold">{{$item->product_title}}</a></h5>
                                                        ...
                                                        @if ($des->display_title == 0)
                                                            {{
                                                              Str::limit(  strip_tags($des->description), 650,'...')
                                                            }}
                                                        @endif
